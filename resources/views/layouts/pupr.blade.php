...
<head>
    ...
    <title>@yield('title', 'Admin PUPR - SIGAP')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-sigap">
        <div class="container">
            <a class="navbar-brand navbar-brand-sigap" href="{{ route('pupr.dashboard') ?? '#' }}">SIGAP - PUPR</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-sigap {{ request()->routeIs('pupr.dashboard') ? 'active' : '' }}" href="{{ route('pupr.dashboard') ?? '#' }}">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-sigap {{ request()->routeIs('pupr.laporan.index') ? 'active' : '' }}" href="{{ route('pupr.laporan.index') ?? '#' }}">Daftar Laporan</a>
                    </li>
                    <li class="nav-item">
                        <form id="logout-form" action="{{ route('pupr.logout') ?? '#' }}" method="POST" class="d-none">
                            @csrf
                        </form>
                    ...
                    @else
                    <li class="nav-item">
                        <a class="nav-link nav-link-sigap" href="{{ route('pupr.login') ?? '#' }}">Login</a>
                    </li>
                    @endif
                </ul>
            </div>
